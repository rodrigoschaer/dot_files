...
require("lazy").setup({
	...
	-- NOTE: plugins can be added using a lua table {}
	-- NOTE: opts = {} forces plugin to load, like require().setup({})
	-- Comment code with commands like "gc"
	...
	{ -- Telescope: The Fuzzy Finder (files, lsp, etc)
	...
	require("schaer.plugins.debug"),
	require("schaer.plugins.indent_line"),
	require("schaer.plugins.harpoon"),
}, {
	ui = {
